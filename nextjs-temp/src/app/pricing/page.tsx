...
export const metadata: Metadata = {
  title: "Pricing",
  description: "Get expert conversion rate optimization insights for your Shopify store. Choose the CRO audit package that fits your needs.",
};
...
function PricingTier({
  ...
  return (
    <div
      className={`rounded-2xl p-8 ${popular ? "border-2 border-boostra-blue shadow-lg" : "border border-gray-200"} relative`}
    >
      {popular && (
      ...
      <div className="mb-6">
        {originalPrice && (
          <div className="flex items-center gap-2 mb-2">
            <span className="text-2xl font-semibold text-boostra-gray line-through">
              ${originalPrice}
            </span>
            <span className="bg-boostra-red text-white px-2 py-1 rounded text-sm font-medium">
              Save $1,500
            </span>
          </div>
        )}
