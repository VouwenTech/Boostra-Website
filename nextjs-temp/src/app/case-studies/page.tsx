...
export const metadata: Metadata = {
  title: "Case Studies",
  description: "Explore how Boostra has helped Shopify store owners transform their businesses through data-driven optimization strategies.",
};
  ...
  return (
    <Card className="overflow-hidden border-none rounded-2xl shadow-sm card-hover">
      ...
      <CardContent className="p-6">
        ...
        <Button
          variant="ghost"
          className="text-boostra-blue p-0 hover:bg-transparent hover:text-boostra-blue/80 flex items-center gap-2"
        >
          View Case Study
          <ArrowRight size={16} />
        </Button>
